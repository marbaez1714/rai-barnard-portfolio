...
export const ProjectRow = ({
  ...
  return (
    <div className="flex">
      <div className="grow justify-end flex h-60 border-y-4 border-r-4 rounded-r-full border-dark-grey shadow-lg relative">
      ...
      <div className="w-[45%]">
        <Link
          to={to}
          relative="path"
          className="gradient-green aspect-square h-60 rounded-full px-8 flex items-center text-white text-3xl"
        >
          {title}
        </Link>
      </div>
